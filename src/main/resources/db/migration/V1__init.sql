...
-- -----------------------------------------------------
-- Table `ecommerce`.`Plaatsen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Plaatsen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Plaatsen` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`Adressen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Adressen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Adressen` (
    ...
    REFERENCES `ecommerce`.`Plaatsen` (`plaatsId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ecommerce`.`Klanten`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Klanten` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Klanten` (
    ...
    REFERENCES `ecommerce`.`Adressen` (`adresId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ecommerce`.`GebruikersAccounts`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`GebruikersAccounts` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`GebruikersAccounts` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`NatuurlijkePersonen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`NatuurlijkePersonen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`NatuurlijkePersonen` (
    ...
    FOREIGN KEY (`klantId`)
    REFERENCES `ecommerce`.`Klanten` (`klantId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    CONSTRAINT `fk_NatuurlijkePersonen_Gebruikersnamen1`
    FOREIGN KEY (`gebruikersAccountId`)
    REFERENCES `ecommerce`.`GebruikersAccounts` (`gebruikersAccountId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ecommerce`.`Rechtspersonen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Rechtspersonen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Rechtspersonen` (
                                                            `klantId` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `ecommerce`.`Contactpersonen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Contactpersonen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Contactpersonen` (
    ...
    FOREIGN KEY (`klantId`)
    REFERENCES `ecommerce`.`Rechtspersonen` (`klantId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ecommerce`.`Categorieen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Categorieen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Categorieen` (
    ...
    REFERENCES `ecommerce`.`Categorieen` (`categorieId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
    ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `ecommerce`.`Leveranciers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Leveranciers` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Leveranciers` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`Artikelen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Artikelen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Artikelen` (
    ...
    REFERENCES `ecommerce`.`Leveranciers` (`leveranciersId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ecommerce`.`ArtikelCategorieen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`ArtikelCategorieen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`ArtikelCategorieen` (
    ...
    REFERENCES `ecommerce`.`Artikelen` (`artikelId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ecommerce`.`Betaalwijzes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Betaalwijzes` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Betaalwijzes` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`BestellingsStatussen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`BestellingsStatussen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`BestellingsStatussen` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`Bestellingen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Bestellingen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Bestellingen` (
    ...
    REFERENCES `ecommerce`.`Betaalwijzes` (`betaalwijzeId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    ...
    REFERENCES `ecommerce`.`BestellingsStatussen` (`bestellingsStatusId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ecommerce`.`Bestellijnen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Bestellijnen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Bestellijnen` (
    ...
    REFERENCES `ecommerce`.`Bestellingen` (`bestelId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ecommerce`.`UitgaandeLeveringsStatussen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`UitgaandeLeveringsStatussen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`UitgaandeLeveringsStatussen` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`UitgaandeLeveringen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`UitgaandeLeveringen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`UitgaandeLeveringen` (
    ...
    REFERENCES `ecommerce`.`UitgaandeLeveringsStatussen` (`uitgaandeLeveringsStatusId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ecommerce`.`KlantenReviews`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`KlantenReviews` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`KlantenReviews` (
    ...
    REFERENCES `ecommerce`.`Bestellijnen` (`bestellijnId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ecommerce`.`VeelgesteldeVragenArtikels`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`VeelgesteldeVragenArtikels` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`VeelgesteldeVragenArtikels` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`MagazijnPlaatsen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`MagazijnPlaatsen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`MagazijnPlaatsen` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`SecurityGroepen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`SecurityGroepen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`SecurityGroepen` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`PersoneelslidAccounts`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`PersoneelslidAccounts` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`PersoneelslidAccounts` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`Personeelsleden`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Personeelsleden` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Personeelsleden` (
    ...
    REFERENCES `ecommerce`.`PersoneelslidAccounts` (`personeelslidAccountId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ecommerce`.`PersoneelslidSecurityGroepen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`PersoneelslidSecurityGroepen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`PersoneelslidSecurityGroepen` (
    ...
    REFERENCES `ecommerce`.`Personeelsleden` (`personeelslidId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    CONSTRAINT `fk_PersoneelslidSecurityGroepen_SecurityGroepen1`
    FOREIGN KEY (`securityGroepId`)
    REFERENCES `ecommerce`.`SecurityGroepen` (`securityGroepId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
    ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `ecommerce`.`InkomendeLeveringen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`InkomendeLeveringen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`InkomendeLeveringen` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`InkomendeLeveringsLijnen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`InkomendeLeveringsLijnen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`InkomendeLeveringsLijnen` (
    ...
    REFERENCES `ecommerce`.`InkomendeLeveringen` (`inkomendeLeveringsId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ecommerce`.`Actiecodes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Actiecodes` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Actiecodes` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`Chatgesprekken`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`Chatgesprekken` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`Chatgesprekken` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`ArtikelLeveranciersInfoLijnen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`ArtikelLeveranciersInfoLijnen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`ArtikelLeveranciersInfoLijnen` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`ChatgesprekLijnen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`ChatgesprekLijnen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`ChatgesprekLijnen` (
    ...
    REFERENCES `ecommerce`.`Chatgesprekken` (`chatgesprekId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ecommerce`.`WishListItems`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`WishListItems` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`WishListItems` (
...
-- -----------------------------------------------------
-- Table `ecommerce`.`EventWachtrijArtikelen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`EventWachtrijArtikelen` ;

CREATE TABLE IF NOT EXISTS `ecommerce`.`EventWachtrijArtikelen` (
                                                                    `artikelId` INT NOT NULL,
                                                                    `aantal` INT NOT NULL,
...
insert into `ecommerce`.`Plaatsen` (plaatsId, postcode, plaats)
values
...
insert into `ecommerce`.`Betaalwijzes` (betaalwijzeId, naam)
values
    (1, 'Niet betaald'),
    (2, 'Kredietkaart'),
    (3, 'Overschrijving');

insert into `ecommerce`.`BestellingsStatussen` (bestellingsStatusId, naam)
values
    (1, 'Lopend'),
    (2, 'Betaald'),
    (3, 'Geannuleerd'),
...
insert into `ecommerce`.`UitgaandeLeveringsStatussen` (uitgaandeLeveringsStatusId, naam)
values
    (1, 'Onderweg'),
    (2, 'Geleverd'),
    (3, 'Verloren'),
...
-- SELECT * FROM INFORMATION_SCHEMA.EVENTS WHERE EVENT_NAME='VerwijderVervallenActiecodesElkeDag' AND EVENT_SCHEMA='ecommerce';
...
DO
BEGIN
delete from ecommerce.Actiecodes where actiecodeId>0 and geldigTotDatum < current_date();
END |
...
values
    ...
    (29,'kruk','houten kruk rood',259,8000,1,10,5,3,6, 1),
    (30,'kruk','houten kruk',379,10000,1,10,5,3,6, 1),
    (31,'kruk','houten kruk rood',469,16000,1,10,5,3,6, 1),
    (32,'kruk','houten kruk blauw',75,2000,1,10,5,3,6, 1),
    (33,'sofa','stoffen 2-zit',350,20000,1,10,5,3,1, 1),
    (34,'sofa','stoffen 3-zit',429,24000,1,10,5,3,1, 1),
    (35,'sofa','stoffen 3-zit',499,28000,1,10,5,3,1, 1),
...
values
    ...
    (60,'Kapstok','Kapstokhaken - set van 9 zwart',60,1000,1,10,5,3,5, 1),
    (61,'Kapstok','Kapstokhaken - set van 3 wit',19,250,1,10,5,3,5, 1),
    (62,'Kapstok','Kapstokhaken - set van 13 wit',60,1000,1,10,5,3,5, 1),
    (63,'Kapstok','Kapstokhaken - 7 wit',35,750,1,10,5,3,5, 1),
    (64,'Staande lamp','Staande lamp - 1 - blauw',149,2500,1,10,5,3,5, 1),
    (65,'Staande lamp','Staande lamp - 1 - wit',119,2500,1,10,5,3,5, 1),
    (66,'Staande lamp','Staande lamp - 1 + leeslicht  - rood',179,3000,1,10,5,3,5, 1),
    (67,'Staande lamp','Staande lamp - 1 + leeslicht  - wit',139,3000,1,10,5,3,5, 1),
    (68,'Hanglamp','Bronzen hanglamp met 3 glazen',119,2500,1,10,5,3,5, 4),
    (69,'Hanglamp','Bronzen hanglamp met 7 glazen',149,3500,1,10,5,3,5, 4),
    (70,'Hanglamp','Koperen hanglamp met 3 glazen',119,2500,1,10,5,3,5, 4),
    (71,'Hanglamp','Koperen hanglamp met 5 glazen',149,3500,1,10,5,3,5, 4),
    (72,'Hanglamp','Industriële metalen hanglamp 3 glazen',99,2500,1,10,5,3,5, 4),
    (73,'Hanglamp','Industriële metalen hanglamp 7 glazen',115,3500,1,10,5,3,5, 4),
...
values
    ...
    (172,'tafelvork 3-pack','staal',55,200,10,100,50,25,50, 3),
    ...
    (194,'eetlepel 7-pack','mat',45,300,10,100,50,25,50, 3),
...
values
    ...
    (207,'blauw wijnglas 6-pack','glas',27,960,10,100,50,25,50, 3),
    (208,'lichtgroen wijnglas 6-pack','glas',24,840,10,100,50,25,50, 3),
    (209,'champagneglas 4-pack','glas',30,840,10,100,50,25,50, 3),
    (210,'limonadeglas 5-pack','glas',12,1200,10,100,50,25,50, 5),
    ...
    (219, 'bewaardoos 1,2 l rechthoekig - set van 5','plastiek',8.99, 150, 10, 100, 50, 25, 50, 2),
    (220, 'bewaardoos 1,5 l rechthoekig - set van 3','plastiek',5.99, 105, 10, 100, 50, 25, 50, 2),
    (221, 'bewaardoos 1,5 l rechthoekig - set van 4','plastiek',10.25, 210, 10, 100, 50, 25, 50, 2),
    (222, 'bewaardoos 2 l rechthoekig - set van 3','plastiek',6.45, 135, 10, 100, 50, 25, 50, 2),
    (223, 'bewaardoos 2 l rechthoekig - set van 5','plastiek',11.45, 270, 10, 100, 50, 25, 50, 2),
    ...
    (229, 'bewaardoos 1 l rechthoekig - set van 5','plastiek',15, 120, 10, 100, 50, 25, 50, 2),
    (230, 'bewaardoos 1,2 l rond - set van 3','plastiek',4.75, 75, 10, 100, 50, 25, 50, 2),
    (231, 'bewaardoos 1,2 l rond - set van 5','plastiek',8.99, 150, 10, 100, 50, 25, 50, 2),
    (232, 'bewaardoos 1,5 l rond - set van 3','plastiek',5.99, 105, 10, 100, 50, 25, 50, 2),
    (233, 'bewaardoos 1,5 l rond - set van 5','plastiek',10.25, 210, 10, 100, 50, 25, 50, 2),
    ...
    (241, 'bewaardoos 1 l rond - set van 5','plastiek',15, 120, 10, 100, 50, 25, 50, 2),
...
values
    ...
    (261, 'wandbrievenbus rood', 'rechthoekige brievenbus met afgeronde hoeken, staal', 40,  3300, 1,10,5, 3, 10, 4),
    (262, 'pakketbrievenbus bruin', 'pakketopening 155 w 340mm, staal', 225,  18500, 1,10,5, 3, 10, 4),
    (263, 'pakketbrievenbus donkerblauw', 'pakketopening 155 w 340mm, staal', 225,  18500, 1,10,5, 3, 10, 4),
    (264, 'staander voor wandbrievenbus geel', 'staal, 1,5 m hoog', 35.5, 230, 1, 10, 5, 3, 10, 4),
...
values
    (1, 'd.ceo@ecommerce.com','$2a$11$KThggo./izUkaugrYvPVueJB7Ib17f.mEFFrtfApfqk8O76AOtpE2'),
    (2, 'k.klantendienst@ecommerce.com','$2a$11$KThggo./izUkaugrYvPVueJB7Ib17f.mEFFrtfApfqk8O76AOtpE2'),
    (3, 'j.leveringen@ecommerce.com','$2a$11$KThggo./izUkaugrYvPVueJB7Ib17f.mEFFrtfApfqk8O76AOtpE2'),
    (4, 'f.magazijn@ecommerce.com','$2a$11$KThggo./izUkaugrYvPVueJB7Ib17f.mEFFrtfApfqk8O76AOtpE2'),
    (5, 'b.website@ecommerce.com','$2a$11$KThggo./izUkaugrYvPVueJB7Ib17f.mEFFrtfApfqk8O76AOtpE2'),
    (6, 'i.artikelbeheer@ecommerce.com','$2a$11$KThggo./izUkaugrYvPVueJB7Ib17f.mEFFrtfApfqk8O76AOtpE2');


insert into GebruikersAccounts (gebruikersAccountId, emailadres, paswoord )
values
    (2, 'ad.ministrateur@vdab.be','$2a$10$XhALoBOP5r8WG/anAu8rsOenXBmjm5F1Ogm/SKxCY.v7eRvHtTXfS'),
    (3, 'alpha.klant@bestaatniet.be','$2a$10$XhALoBOP5r8WG/anAu8rsOenXBmjm5F1Ogm/SKxCY.v7eRvHtTXfS'),
    (4, 'beta.client@bestaatniet.be','$2a$10$XhALoBOP5r8WG/anAu8rsOenXBmjm5F1Ogm/SKxCY.v7eRvHtTXfS'),
    (5, 'gamma.customer@bestaatniet.be','$2a$10$XhALoBOP5r8WG/anAu8rsOenXBmjm5F1Ogm/SKxCY.v7eRvHtTXfS'),
    (6, 'delta.kunde@bestaatniet.be','$2a$10$XhALoBOP5r8WG/anAu8rsOenXBmjm5F1Ogm/SKxCY.v7eRvHtTXfS'),
    (7, 'eta.cliente@bestaatniet.be','$2a$10$XhALoBOP5r8WG/anAu8rsOenXBmjm5F1Ogm/SKxCY.v7eRvHtTXfS'),
    (8, 'in.koper@vdab.be','$2a$10$XhALoBOP5r8WG/anAu8rsOenXBmjm5F1Ogm/SKxCY.v7eRvHtTXfS'),
    (9, 'de.baas@rva.be','$2a$10$XhALoBOP5r8WG/anAu8rsOenXBmjm5F1Ogm/SKxCY.v7eRvHtTXfS');
...
DROP TABLE IF EXISTS `ecommerce`.`Winkelmanden` ;
CREATE TABLE Winkelmanden (
                              winkelmandId INT AUTO_INCREMENT PRIMARY KEY,

                              klantId INT NULL UNIQUE,

                              sessieId CHAR(36) NULL,

                              laatsteActiviteit DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,

                              CONSTRAINT FK_Winkelmand_Klant
                                  FOREIGN KEY (klantId)
                                      REFERENCES Klanten(klantId),

                              CONSTRAINT CK_Winkelmand_Eigenaar
                                  CHECK (
                                      (klantId IS NOT NULL AND sessieId IS NULL)
                                          OR
                                      (klantId IS NULL AND sessieId IS NOT NULL)
                                      )
);

DROP TABLE IF EXISTS `ecommerce`.`WinkelmandLijnen` ;
CREATE TABLE WinkelmandLijnen (
                                  winkelmandLijnId INT AUTO_INCREMENT PRIMARY KEY,

                                  winkelmandId INT NOT NULL,

                                  artikelId INT NOT NULL,

                                  aantal INT NOT NULL,

                                  CONSTRAINT FK_WinkelmandLijn_Winkelmand
                                      FOREIGN KEY (winkelmandId)
                                          REFERENCES Winkelmanden(winkelmandId),

                                  CONSTRAINT FK_WinkelmandLijn_Artikel
                                      FOREIGN KEY (artikelId)
                                          REFERENCES Artikelen(artikelId),

                                  CONSTRAINT CK_WinkelmandLijn_Aantal
                                      CHECK (aantal > 0),

                                  UNIQUE (winkelmandId, artikelId)
);

CREATE INDEX IX_Winkelmand_Klant
    ON Winkelmanden(klantId);

CREATE INDEX IX_Winkelmand_Sessie
    ON Winkelmanden(sessieId);
